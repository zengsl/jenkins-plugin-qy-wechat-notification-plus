...
public class QyWechatNotification extends Publisher implements SimpleBuildStep {
    ...
    public void perform(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener) throws InterruptedException, IOException {
        ...
        /*System.out.println("getFullDisplayName:"+run.getParent().getFullDisplayName());
        System.out.println("getFullDisplayName:"+run.getParent().getDescription());
        System.out.println("getFullDisplayName:"+run.getFullDisplayName());
        System.out.println("getFullDisplayName:"+run.getDisplayName());
        System.out.println("getFullDisplayName:"+run.getBuildStatusSummary());*/
        //设置当前项目名称
        this.projectName = run.getParent().getFullDisplayName();
        this.projectDescription = run.getParent().getDescription();
        //构建结束通知
        BuildOverInfo buildInfo = new BuildOverInfo(this.projectName,this.projectDescription,  run, config);
